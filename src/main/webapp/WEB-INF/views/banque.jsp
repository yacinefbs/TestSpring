...
<body>
	...
	<c:if test="${not empty banqueForm.compte.solde}">
	<div>
	<table>
		<tr>
			<td>Solde : </td>
	...
	<div>
		...
		<div>
			<c:forEach begin="1" end="${banqueForm.nombrePages-1 }" var="p">
				<c:choose>
					...
					<c:otherwise>
						<span class="autrePage">
							<a href="chargerCompte?page=${p}&code=${banqueForm.code}"><span>Page ${p}</span></a>
						</span>
					</c:otherwise>
				</c:choose>
